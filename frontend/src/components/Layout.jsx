...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-950 font-sans text-slate-200">
        ...
        <div className="max-w-[1600px] mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col">
              <span className="text-sm md:text-base font-black tracking-tight text-white hidden sm:block leading-none">
      ...
      {/* ── PREMIUM FOOTER ── */}
      <footer className="w-full bg-slate-900 border-t border-slate-800 pt-16 pb-8 mt-auto">
        <div className="max-w-[1400px] mx-auto px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12 border-b border-slate-800 pb-12">
            ...
            <div className="flex flex-col items-center md:items-start text-center md:text-left">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-xl font-black text-white">FEIRS</span>
              </div>
            ...
            {/* Support Column */}
            <div className="flex flex-col items-center md:items-start text-center md:text-left">
              <h4 className="text-white font-bold text-sm mb-4 tracking-wide">SYSTEM SUPPORT</h4>
              <ul className="flex flex-col gap-3 text-slate-400 text-sm">
                <li className="flex items-center gap-3 hover:text-cyan-400 cursor-pointer transition-colors">
            ...
            {/* Legal Column */}
            <div className="flex flex-col items-center md:items-start text-center md:text-left">
              <h4 className="text-white font-bold text-sm mb-4 tracking-wide">COMPLIANCE</h4>
              <ul className="flex flex-col gap-3 text-slate-400 text-sm">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-slate-500 font-semibold text-xs">
