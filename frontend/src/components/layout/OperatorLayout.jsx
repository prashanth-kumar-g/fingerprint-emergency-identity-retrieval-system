...
export default function OperatorLayout() {
  ...
  const navLinks = [
    { name: 'Enroll Citizens', path: '/operator/enroll-citizens', icon: UserPlus },
    { name: 'Manage Citizens', path: '/operator/manage-citizens', icon: Users },
    { name: 'Emergency Scan', path: '/operator/emergency-scan', icon: ScanLine },
    { name: 'Statistics & Logs', path: '/operator/statistics', icon: Activity },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-300 font-sans flex flex-col overflow-x-hidden">
      ...
      <header className="w-full bg-[#020617]/90 backdrop-blur-xl border-b border-slate-800/80 sticky top-0 z-50 flex items-center justify-between px-6 py-5 shadow-lg">
        ...
        >
          <div className="w-12 h-12 rounded-xl bg-red-900/30 border border-red-500/40 flex items-center justify-center group-hover:scale-105 transition-transform shadow-[0_0_15px_rgba(239,68,68,0.3)]">
          ...
          <div className="flex flex-col">
            ...
            <p className="text-xs font-bold tracking-[0.2em] text-red-400 uppercase mt-1">Operator</p>
          </div>
        </div>
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2.5 rounded-xl transition-all duration-300 text-sm font-bold tracking-wide ${
                  isActive 
                    ? 'bg-red-900/20 text-red-400 border border-red-500/30 shadow-[0_0_15px_rgba(239,68,68,0.15)]' 
      ...
      <main className="flex-1 flex flex-col relative p-6 md:p-12 overflow-x-hidden">
        ...
        <div className="absolute top-[-10%] left-1/2 -translate-x-1/2 w-[1000px] h-[600px] bg-red-900/10 blur-[150px] pointer-events-none rounded-[100%] z-0" />
      ...
      <footer className="py-8 bg-[#02040c] border-t border-slate-800/60 mt-auto flex flex-col items-center justify-center gap-2 relative z-10">
        ...
        <p className="text-xs font-medium text-slate-500">
          Emergency Medical Scanner Module • Secure Connection
        </p>
