...
const roleConfigs = {
  'super-admin': {
    title: 'Recover Super Admin Access',
    subtitle: 'GLOBAL OVERWATCH RECOVERY',
    icon: Shield,
    color: 'text-cyan-400',
  ...
  'institution': {
    ...
    subtitle: 'FACILITY COMMAND CENTER RECOVERY',
    icon: Building2,
  ...
  'operator': {
    ...
    subtitle: 'EMERGENCY MEDICAL SCANNER RECOVERY',
    icon: Stethoscope,
    color: 'text-red-400',
          ...
          {status === 'success' ? (
            ...
            >
              ...
              <p className="text-slate-400 text-sm leading-relaxed mb-8">
                An email has been sent with a secure link to reset your password. Please check your inbox.
              </p>
            ...
            <form className="flex flex-col gap-6" onSubmit={handleResetRequest}>
