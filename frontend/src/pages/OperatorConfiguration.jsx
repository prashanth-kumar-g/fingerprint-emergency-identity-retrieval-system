...
export default function OperatorConfiguration() {
  ...
  const handleSave = () => {
    ...
    setTimeout(() => {
      setIsSaving(false);
      triggerAlert('success', 'Operator profile updated successfully!');
    }, 1200);
  };
      ...
      <div className="w-full max-w-[1400px] mx-auto px-4 lg:px-0 mt-2 flex flex-col gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <button 
            ...
            className="flex-[2] flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-500 text-white px-8 py-4 rounded-xl font-bold text-lg transition-all shadow-[0_0_20px_rgba(16,185,129,0.3)] disabled:opacity-70 disabled:cursor-not-allowed"
          >
            {isSaving ? (
              <>
