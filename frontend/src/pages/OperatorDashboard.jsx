...
const cards = [
  {
    key: 'enroll-citizens',
    title: 'Enroll Citizens',
    subtitle: 'Biometric Registration',
    description: 'Register new citizens into the FEIRS database by securely scanning and storing their fingerprints.',
    icon: UserPlus,
    path: '/operator/enroll-citizens',
  ...
  },
  {
    ...
    subtitle: 'Citizen Directory',
    description: 'Update personal details, suspend access, or delete records for registered citizens.',
    icon: Users,
    path: '/operator/manage-citizens',
  ...
  },
  {
    ...
    subtitle: 'Instant ID Retrieval',
    description: 'Initiate a live fingerprint scan to instantly retrieve a patient\'s identity and critical medical details.',
    icon: ScanLine,
    path: '/operator/emergency-scan',
  ...
  },
  {
    ...
    subtitle: 'Operational Audits',
    description: 'Review your personal scan history, success rates, and shift activity logs.',
    icon: Activity,
    ...
    <div className="w-full flex flex-col items-center gap-6 pb-20">
      ...
      <div className="w-full relative flex flex-col items-center justify-center text-center mt-2 mb-8 max-w-[1400px] mx-auto">
        ...
        <p className="text-sm text-slate-400 font-medium whitespace-nowrap">
          Welcome back to your Emergency Scanner module. Select a sector below to manage citizen data or execute an emergency identity scan.
        </p>
      </div>
