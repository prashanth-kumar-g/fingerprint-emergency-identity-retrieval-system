...
const mockLogs = [
  {
    id: 'log-1',
    timestamp: 'Oct 24, 2026 - 09:00:15',
    actorRole: 'Operator',
    actorName: 'Subham',
    actorId: 'FEIRS-OP-8821',
    action: 'Logged into Emergency Command Center',
    targetRole: null,
    targetName: 'Emergency Command Center',
    targetId: '',
    status: 'SUCCESS',
  ...
  {
    id: 'log-2',
    timestamp: 'Oct 24, 2026 - 09:15:30',
  ...
  {
    id: 'log-3',
    timestamp: 'Oct 24, 2026 - 10:22:11',
    actorRole: 'Operator',
    actorName: 'Subham',
    actorId: 'FEIRS-OP-8821',
  ...
  {
    id: 'log-4',
    timestamp: 'Oct 24, 2026 - 11:45:10',
    actorRole: 'Operator',
    actorName: 'Subham',
    actorId: 'FEIRS-OP-8821',
  ...
  {
    id: 'log-5',
    timestamp: 'Oct 24, 2026 - 13:05:22',
    actorRole: 'Operator',
    actorName: 'Subham',
    actorId: 'FEIRS-OP-8821',
    action: 'Enrolled New Biometric Profile',
    targetRole: 'Citizen',
    targetName: 'Priya',
    targetId: 'FEIRS-CITZ-1288',
    status: 'SUCCESS',
    statusColor: 'text-emerald-400 bg-emerald-500/10 border-emerald-500/30'
  },
  {
    id: 'log-6',
    timestamp: 'Oct 24, 2026 - 17:00:05',
    actorRole: 'Operator',
    actorName: 'Subham',
    actorId: 'FEIRS-OP-8821',
    action: 'Securely Logged Out',
    targetRole: null,
    targetName: 'Emergency Command Center',
    targetId: '',
    status: 'INFO',
          ...
          <div className="p-4 border-b border-slate-800 flex flex-col sm:flex-row gap-4 items-center justify-between bg-slate-950/50 relative">
            <div className="relative w-full sm:w-96">
              <button onClick={simulateSearch} className="absolute left-3 top-1/2 -translate-y-1/2 group">
                <Search className="w-4 h-4 text-slate-500 group-hover:text-red-400 transition-colors" />
              </button>
              <input 
                type="text" 
                value={searchQuery}
                ...
                className="w-full bg-slate-900 border border-slate-700 rounded-lg pl-10 pr-4 py-2 text-sm text-white placeholder:text-slate-500 focus:outline-none focus:border-red-500/50 transition-colors"
              />
            </div>
            ...
            <div className="relative w-full sm:w-auto">
              <button 
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm transition-colors w-full sm:w-auto justify-center border ${showFilters ? 'bg-slate-800 border-red-500/50 text-white' : 'bg-slate-900 border-slate-700 text-slate-300 hover:text-white hover:border-slate-500'}`}
              >
                <Filter className="w-4 h-4" />
                Advanced Filters
                {hasActiveFilters && (
                  <span className="flex items-center justify-center w-5 h-5 ml-1 rounded-full bg-red-500 text-slate-950 text-[10px] font-black">
                  ...
                  >
                    <div className="flex flex-col gap-1">
                      ...
                      <select 
                        ...
                        className="bg-slate-950 border border-slate-800 text-slate-300 text-sm rounded-lg p-2 focus:outline-none focus:border-red-500/50"
                      >
                    ...
                    <button 
                      ...
                      className="w-full mt-2 py-2 bg-red-600 hover:bg-red-500 text-white text-sm font-bold rounded-lg transition-colors flex items-center justify-center gap-2"
                    >
                      Apply Filters
                    </button>
                  </motion.div>
          ...
          {hasActiveFilters && (
            <div className="px-4 py-3 border-b border-slate-800 bg-slate-950/30 flex flex-wrap gap-2 items-center">
              ...
              {Object.entries(activeFilters).map(([key, value]) => {
                ...
                return (
                  <span key={key} className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-red-900/30 border border-red-500/30 text-red-400 text-xs font-medium">
          ...
          <div className="w-full overflow-x-auto min-h-[350px] max-h-[430px] overflow-y-auto custom-scrollbar relative">
            ...
            <AnimatePresence>
              {isSearching && (
                ...
                >
                  ...
                  <p className="text-sm text-red-400 font-medium tracking-wide">Searching Logs...</p>
                </motion.div>
              )}
            </AnimatePresence>
            ...
            <table className="w-full text-left border-collapse min-w-[1000px]">
              <thead className="bg-slate-950/80 sticky top-0 z-10 backdrop-blur-md">
                <tr>
                  <th className="p-4 text-xs font-bold text-slate-400 uppercase tracking-wider border-b border-slate-800 w-[210px]">Timestamp</th>
                  <th className="p-4 text-xs font-bold text-slate-400 uppercase tracking-wider border-b border-slate-800 w-[310px]">Actor</th>
                  ...
                  <th className="p-4 text-xs font-bold text-slate-400 uppercase tracking-wider border-b border-slate-800 w-[130px] text-left">Status</th>
                </tr>
              </thead>
