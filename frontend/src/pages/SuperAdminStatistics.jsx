...
const mockLogs = [
  {
    id: 'log-1',
    timestamp: 'Oct 24, 2026 - 14:32:05',
    actorRole: 'Super Admin',
    actorName: 'Rajesh',
    actorId: 'FEIRS-SA-ROOT',
    action: 'Logged into Global Overwatch Portal',
    targetRole: null,
    targetName: 'Global Overwatch Portal',
    targetId: '',
    status: 'SUCCESS',
  ...
  {
    id: 'log-2',
    timestamp: 'Oct 24, 2026 - 14:15:22',
    actorRole: 'Super Admin',
    actorName: 'Rajesh',
    actorId: 'FEIRS-SA-ROOT',
    action: 'Approved Network Registration',
    targetRole: 'Institution',
    targetName: 'Apollo Hospital',
    targetId: 'FEIRS-INST-1011',
    status: 'SUCCESS',
    statusColor: 'text-emerald-400 bg-emerald-500/10 border-emerald-500/30'
  },
  {
    id: 'log-3',
    timestamp: 'Oct 24, 2026 - 13:40:11',
    actorRole: 'Super Admin',
    actorName: 'Rajesh',
    actorId: 'FEIRS-SA-ROOT',
    action: 'Suspended System Access',
    targetRole: 'Institution',
    targetName: 'City Care Clinic',
    targetId: 'FEIRS-INST-2099',
    status: 'WARNING',
    statusColor: 'text-amber-400 bg-amber-500/10 border-amber-500/30'
  },
  {
    id: 'log-4',
    timestamp: 'Oct 24, 2026 - 13:10:05',
    actorRole: 'System',
    actorName: 'Security Firewall',
    actorId: 'FEIRS-SYS-FW',
    action: 'Blocked Unauthorized Login',
    targetRole: 'Network',
    targetName: 'IP Address',
    targetId: '45.33.22.11',
    status: 'FAILED',
    statusColor: 'text-red-400 bg-red-500/10 border-red-500/30'
  },
  {
    id: 'log-5',
    timestamp: 'Oct 24, 2026 - 11:22:45',
    actorRole: 'Institution',
    actorName: 'Apollo Hospital',
    actorId: 'FEIRS-INST-1011',
    action: 'Submitted Request for Address Update',
    targetRole: 'System',
    targetName: 'Data Update Queue',
    targetId: 'REQ-9901',
    status: 'INFO',
            ...
            <AnimatePresence>
              {isSearching && (
                ...
                >
                  ...
                  <p className="text-sm text-cyan-400 font-medium tracking-wide">Searching Logs...</p>
                </motion.div>
              )}
            </AnimatePresence>
